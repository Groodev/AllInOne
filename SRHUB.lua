...
AllScriptTab:Button({
    ...
    Callback = function()
        inject_safe("https://raw.githubusercontent.com/fearlessd3v/TEAM-FEARLESS/refs/heads/main/fearless-chat-bypass") -- common link
    end
})
...
AllScriptTab:Button({
    ...
    Callback = function()
        inject_safe("https://raw.githubusercontent.com/Angelo-Gitland/Lua-Land-Hub-Version-7/refs/heads/main/Lua%20Land%20Hub%20V7") -- common link
    end
})

AllScriptTab:Button({
    Title = "solaris",
    Desc = "Injects solaris",
    Callback = function()
        inject_safe("https://raw.githubusercontent.com/roburox/s1mple/main/load.lua") -- common link
    end
})
